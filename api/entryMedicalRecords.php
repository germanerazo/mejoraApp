...
require_once '../class/entryMedicalRecords.class.php';
...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'GET':
        ...
        echo json_encode($_emr->list($_GET['idEmpresa'], $_GET['idEntry']));
