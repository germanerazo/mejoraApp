...
require_once '../class/riskConsolidation.class.php';

$_answers = new answers;
$_riskCons = new riskConsolidation;
...
switch ($_SERVER['REQUEST_METHOD']) {
    case 'GET':
        ...
        if (isset($_GET['idEmpresa'])) {
            $data = $_riskCons->getProgram($_GET['idEmpresa']);
    ...
    case 'POST':
        ...
        if (isset($data['idEmpresa'])) {
            $dataArray = $_riskCons->saveActionData($data);
