...
require_once '../class/processes.class.php';
...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'GET':
        ...
        if (isset($_GET['idEmpresa'])) {
            $data = $_processes->getProcesses($_GET['idEmpresa']);
    ...
    case 'POST':
        ...
        $dataArray = $_processes->createProcess($data);
    ...
    case 'PUT':
        ...
        $dataArray = $_processes->updateProcess($data);
    ...
    case 'DELETE':
        ...
        $dataArray = $_processes->deleteProcess($data);
