...
<div class="emergency-container">
    ...
    <div id="emergencyListView" class="content-card">
        <div class="emergency-toolbar">
            ...
            <button class="btn-add-circle" onclick="showCreateEmergency()" title="Nuevo Registro">
    ...
    <div id="emergencyCreateView" class="content-card" style="display: none;">
        ...
        <form id="emergencyForm">
            ...
            <div class="form-group">
                ...
                <input type="file" id="planFile" class="form-input">
            </div>

            <div style="margin-top: 20px;">
                <button type="button" class="btn-secondary" onclick="hideCreateEmergency()">Volver</button>
                <button type="button" class="btn-orange" onclick="saveEmergency()">Guardar</button>
            </div>
        </form>
    </div>
</div>
